...
class AppConstants {
  static const String appName = 'FidesPay';
  static const String baseUrl = 'https://appcrm.fidespay.it';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.saudi, languageName: 'Italiano', countryCode: 'IT', languageCode: 'it'),
